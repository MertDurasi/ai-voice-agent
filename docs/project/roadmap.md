...
Stand: 2026-08-11. Ausführbar sind ausschließlich die Task-Verträge unter
...
| Foundation und Tenant-Isolation sind beweisbar | `F-005` schließt `G1`; danach `T-001`–`T-004` für `G2` | reproduzierbare CI sowie Auth-/RLS-/Audit-Negativfälle; keine reale Tenant-PII |
